...
<div class="logo" >
    ...
    <div class="container">
        ...
        <form action="admin.php" method="post">
            ...
            <center><h1  style="font-size:300%; color: rgb(183, 185, 98);font-family: Serif;"> SIGN UP</h1></center>
        ...
        <div>
        <div><p>Already Registered <a href="admin.php">Login Here</a></p></div>
      </div>
    </div>
</body>
</html>